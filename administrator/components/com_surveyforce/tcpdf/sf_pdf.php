...
class sf_pdf {
	...
	function sf_pdf($options = array()) {
		global $mosConfig_absolute_path, $mosConfig_sitename, $mosConfig_live_site, $mosConfig_offset;
		...
		require_once(_SURVEY_FORCE_ADMIN_HOME . '/tcpdf/tcpdf.php');
		...
		$this->_engine->setHeaderData('', 0, $mosConfig_sitename, $mosConfig_live_site." "._SURVEY_FORCE_COMP_NAME."     "._PDF_GENERATED .' '. date( 'j F, Y, H:i', time() + $mosConfig_offset * 60 * 60 ) );	
